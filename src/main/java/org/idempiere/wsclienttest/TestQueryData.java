...
//		return "Query BPartner Test"; //name
	}
...
/* coba diremark dulu biar ga kleru */
/* pakai ini jika kirim input parameter */		
//		DataRow data = new DataRow();
//		data.addField("Name", "%Store%");
//		data.addField("Name", "%Bintang%");
//		data.addField("TableName", "C_BPartner");
//		ws.setDataRow(data);
/* yes..!!! jalan setelah diremark */
